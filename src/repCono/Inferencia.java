...
public class Inferencia {
  ...
  public Inferencia(BaseCono BC) {
    ...
    this.conoFinal = new HashSet<String>(BC.getListaHechos()); // antes de la inferencia, solo se sabe los hechos
                                                               // iniciales
  }
   ...
   * inferencia:
   * esto incluye los hechos iniciales mas los que se han ido concluyendo durante
   * el encadenamiento al
   * aplicar Modus Ponens
   * 
   * @return el conjunto de variables proposicionales que sabemos que son ciertas
   *         (hechos)
   */
